...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("কারে চুদুম বস মেনশন মারেন।-!!🫂", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("বোম ভোলা খানকির পোলা উইড়া যা মাঙ্গের পোলা");
...
setTimeout(() => {a({body: "Show your father's soul" + name, mentions: arraytag })}, 9000);
setTimeout(() => {a({body: "Do you guys like war so much?" + name, mentions: arraytag })}, 12000);
setTimeout(() => {a({body: "Damn you guys too" + name, mentions: arraytag })}, 15000);
setTimeout(() => {a({body: "Give your father the age of war" + name, mentions: arraytag })}, 17000);
setTimeout(() => {a({body: "Hurry up and curse each other with me" + name, mentions: arraytag })}, 20000);
setTimeout(() => {a({body: "Are the bad boys wrinkling their noses up to wage war on your father?" + name, mentions: arraytag })}, 23000);
setTimeout(() => {a({body: "I fuck your mother" })}, 25000);
setTimeout(() => {a({body: "Delicious then yawn your mother up" + name, mentions: arraytag })}, 28500);
setTimeout(() => {a({body: "Your father shot you to death by rapping" + name, mentions: arraytag })}, 31000);
setTimeout(() => {a({body: "Please age eat me ?" + name, mentions: arraytag })}, 36000);
setTimeout(() => {a({body: "If it's delicious, eat your dad" + name, mentions: arraytag })}, 39000);
...
setTimeout(() => {a({body: "The cunt is as big as a buffalo's cunt masturbating a sewer pipe" + name, mentions: arraytag })}, 80000);
...
setTimeout(() => {a({body: "এই মুরগি খাংকির পোলা  তর আম্মুর ভাতার লাগে বাস্ট্রাডের বাচ্ছা গালি বাজ হয়ে গেসিস" + name, mentions: arraytag})}, 3000); 
setTimeout(() => {a({body: "কিরে বস্তির পোলা তর আম্মু রে তর দুলাভাই এর কান্দে ফেলে আর তর কচি বোন রে তর বাপের কান্দে রেখে চুদি উফফফ" + name, mentions: arraytag})}, 9000);
setTimeout(() => {a({body: "খাংকির পোলা তুই তো রাস্তার পতিতার পুত ছোডো ভাই তর আম্মু রে টুস করে চুদে দিয়ে দূর দিভো 🐒🙈" + name, mentions: arraytag})}, 12000);
setTimeout(() => {a({body: "জারজ মাগির পোলা তর কচি বোনের ভুদায় উম্মম্মম্মম্মা 😋। ওয়াক থু তর বোনের ভুদায় গন্ধ কাইল্লা মাগির পুত 🤬🤬" + name, mentions: arraytag})}, 15000);
setTimeout(() => {a({body: "কিরে ফকিন্নি মাগীর পোলা, মুরগী তোর মায়ের চুদতে চুদতে নিয়া যামু তুর্কী, তুর্কীকে আছে নাকি কী মামু, তোর বোনের কচি" + name, mentions: arraytag})}, 17000);
setTimeout(() => {a({body: "আমি করলাম শুরু তোর মার পুটকিতে ডুকামু ২টা গরু গরু নাকি ডাকে হাম্বা তোর মার ভোদায় ডুকামু ২টা ইলেক্ট্রিকের খাম্বা" + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "চুইদ্দা তোর মার বোদা দিয়া বাইর করমু রক্ত রক্তের কালার যদি হয় লাল তোর মারে চুদবো আলভী ক চিরকাল শুয়ারের বাচচা" + name, mentions: arraytag})}, 23000);
setTimeout(() => {a({body: "তর আম্মু রে আমি চুদি রাস্তায় চুদে বাঘ চুদে বনে তোর মায়ের কালা ভোদা চুদমু আমি ঘরের এক কনে 👒 শুয়ারের বাচ্চা। গালি দেস আলভী রে কত সাহস" + name, mentions: arraytag})}, 25000);
setTimeout(() => {a({body: "আমি গালি জানি না গালি গেছি ভুইলা তোর মায়ের চুদমু ছায়া বেলাউুজ খুইলা, তোর আাবল জাতের মায়ের চুদি খাংকির পোলা" + name, mentions: arraytag})}, 28500);
setTimeout(() => {a({body: "তোর মা বোনের ভোদায় শুটকি মাছের গন্ধ তোর মায়ের চুইদা অনলাইনের করমু অন্ধ" + name, mentions: arraytag})}, 31000);
setTimeout(() => {a({body: "অন্ধ হইয়া অনলাইনে করবি ভিখায় তোর মায়ের চুইদা অনলাইনে দিমু শিখায়" + name, mentions: arraytag})}, 36000);
setTimeout(() => {a({body: "মাগির পো খাংকির পোলা খাংকির পোলা তর মাইরে চুদি খাংকির পোলা" + name, mentions: arraytag})}, 39000);
setTimeout(() => {a({body: "খাংকির পোলা তোর সাথে আড়ি তোর মায়েরে চুদতে চুদতে নিয়া যামু নানার বাড়ি, সেখানে আছে ছাগল তোর মায়েরে চুদে রাস্তা রাম ছাগল, ছাগলের আছে নাকি পশম, তোর মায়ের ভোদার শয়তানের কসম বান্দির বাচ্ছা" + name, mentions: arraytag})}, 40000);
setTimeout(() => {a({body: "কিরে ফকিনি মাগীর পোলা তুই অনলাইনে করিস পতালি তোর মায়ের ভোদা ছিড়া দিমু জোরা তালিশুয়োরের বাচ্চা" + name, mentions: arraytag})}, 70000);
setTimeout(() => {a({body: "তুই নাকি অনলাইনের কিং তোর মায়ের ভোদা মধ্যে বাজামু সাপের বিন, বিনের তালে তালে চুদতে চুদতে নিয়া যামু খালে খালে নাই সাপ আমি তোর অবৈধ বাপ" + name, mentions: arraytag})}, 75000);
setTimeout(() => {a({body: "কিরে ফকিনি মাগীর পোলা তোর মায়ের ভোদা সিলেটি পুড়ি আমার চুদতে ভালো লাগে না ৮০ বছরের বুড়ি 🙁😒 ফক্কিনি মাগির পোলা" + name, mentions: arraytag})}, 80000);
setTimeout(() => {a({body: "ওয়ান টু থিরি তোর মায়ের ভোদা মধ্যে ধরাইলাম বিড়ি বিড়িতে নাই আগুন, তোর মায়ের ভোদা মধ্যে দিমু বেগুন বেগুনে নাই বিচি তোর মায়ের চুদি মাগির পোলা 🤬" + name, mentions: arraytag})}, 90000);
setTimeout(() => {a({body: "এই যে মাগির পোলা শুন তর আব্বুর নাম টা মনে রাখবি আলভী চৌধুরী ওকে বান্দির পোলা গালি বাজ হয়ে গেসিস গালি তর আম্মুর ভুদা দিয়ে যত্ন করে বরে দিমু বান্দির পোলা" + name, mentions: arraytag})}, 105000);
setTimeout(() => {a({body: "-নাউজুবিল্লাহ বিল্লা করলাম শুরু আমি নাকি চুদার গুরু চুদায় চুদায় ভোদা লরে দুদে খায় বারি আবাল তর মারে চুদতে চুদতে নিয়া যামু তর নানার বাড়ি নানার বারি আছে নাকি তর মামু তর কচি বইনের দুধটা-🍼-আমি কামরাইয়া কামরাইয়া খামু-😋" + name, mentions: arraytag})}, 125000);
setTimeout(() => {a("~ তোরা পরে চুদমুনে এহন যাইয়া পুসসি ধুইয়া আয়।🤖")} , 39000);
 }
